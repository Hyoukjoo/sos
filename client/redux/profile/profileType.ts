...
interface I_changeProfileImageNameRequest {
  type: E_profileType.CHANGE_PROFILE_IMAGE_NAME_REQUEST;
  data: I_changeProfileImageNameInfo;
}

interface I_changeProfileImageNameSuccesss {
  type: E_profileType.CHANGE_PROFILE_IMAGE_NAME_SUCCESS;
}

interface I_changeProfileImageNameFailure {
  type: E_profileType.CHANGE_PROFILE_IMAGE_NAME_FAILURE;
  message: string;
}

interface I_changeProfileImageNameError {
  type: E_profileType.CHANGE_PROFILE_IMAGE_NAME_ERROR;
  error: Error;
}
...
interface I_initializeFailureMessageRequest {
  type: E_profileType.INITIALIZE_FAILURE_MESSAGE_REQUEST;
}

...
export const sequelize = new Sequelize('mysql://root:root@localhost:3306/test');
...
Address.belongsTo(User, { targetKey: 'id', foreignKey: 'addressId' });
User.hasOne(Address, { sourceKey: 'id', foreignKey: 'addressId' });
